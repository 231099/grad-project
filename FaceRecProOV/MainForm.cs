...
namespace MultiFaceRec
{
    public partial class FrmPrincipal : Form
    {
        ...
        public FrmPrincipal()
        {
            ...
            catch(Exception e)
            {
                ...
                MessageBox.Show("Nothing in binary database,"+
                    "please add at least a face(Simply train the prototype with the Add "+
                    "Face Button)."," Triained faces load",
        ...
        private void button3_Click_1(object sender, EventArgs e)
        {
            ...
            Image img = Image.FromFile(Application.StartupPath + "/person/" + "1.jpg");
            byte[,,] bArr = (byte[,,])imgCon.ConvertTo(img, typeof(byte[]));
            person = new Image<Gray,byte>(bArr);
            //Face Detector
            MCvAvgComp[][] facesDetected = person.DetectHaarCascade(face, 1.2, 10,
