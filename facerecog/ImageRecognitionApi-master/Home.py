...
RelatedReport_Schema = RelatedReportSchema()
RelatedReports_Schema = RelatedReportSchema(many=True)
...
Loaction_Schema = LoactionnSchema()
Loactions_Schema = LoactionnSchema(many=True)
